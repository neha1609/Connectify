...
<body>
  ...
  ?>
    ...
    $p_pro = "Select * from products where product_id='$p_id'";

    $run_p = mysqli_query($con,$p_pro);
    $row_pro=mysqli_fetch_array($run_p);
    ...
    <section class="text-gray-600 body-font overflow-hidden">
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="image/<?php echo $p_img; ?>">
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <!--<h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>-->
            <h1 class="text-gray-900 text-3xl title-font font-medium mb-1"><?php echo $p_title; ?></h1>
            <div class="flex mb-4">
            ...
            <p class="leading-relaxed"><?php echo $p_desc; ?></p>
